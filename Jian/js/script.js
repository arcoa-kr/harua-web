...
====================================== */
    ...
    $('#work_slider .owl-dot').addClass('link');
...
$("#submit_btn").on('click', function () {
    ...
    if (proceed) {
        ...
        var output = '<div class="alert-danger" style="padding:10px 15px; margin-bottom:30px;">Please provide the missing fields.</div>';
        $("#result").hide().html(output).slideDown();
...
function Showcase() {
    ...
    $('.section-image').each(function() {
        ...
        if (window.innerWidth <= 768) {
            // project-01.jpg → project-01-mobile.jpg
            var mobileImage = image.replace(/(\.[\w\d_-]+)$/i, '-mobile$1');
